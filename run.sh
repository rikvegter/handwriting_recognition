...
function download_image() {
    ...
    test $(stat --printf="%s" save_tree_save_world_hwr.docker) -gt 1000000 || { echo "Failed to download file! Please get it manually here: "; echo "https://drive.google.com/file/d/1ckqogv-WzmlrzskR_wF4V4e5vtIH5Oh2/view?usp=sharing"; echo "And then import it this way ''"; exit 1; }
